<script lang="ts">
	 ...
	 * Fetches from /api/summary/weekly/ai endpoint powered by local Ollama
	 */
	...
	async function fetchSummary() {
		...
		try {
			const response = await api.GET('/api/summary/weekly/ai', {
...
<div class="ai-summary">
	<div class="summary-header">
		<div class="header-left">
			...
			<span class="header-title">AI Weekly Summary</span>
		</div>
		<button
		...
		<div class="summary-content">
			...
			<div class="report-fineprint">
				...
				<p class="fineprint-text">
					This report was generated by <strong>Woofalytics v2.1.0</strong> automated noise monitoring system.<br>
					Detection: CLAP + YAMNet neural networks ({Math.round(summary.generation_time_ms / 100) > 0 ? '98' : '98'}% confidence) •
	...
	{:else}
		<div class="summary-empty">
			<p>Click "Generate" to create an AI-powered summary of this week's bark activity.</p>
